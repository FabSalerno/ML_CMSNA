...
for t in h.keys():
    ...
    if "tt" in sample:
        CMS.SaveCanvas(canv, "/eos/user/f/fsalerno/Evaluation/TROTA_2018_plots/tt_semilep_noResinMix/"+canv_name+".png", close=False)
        CMS.SaveCanvas(canv, "/eos/user/f/fsalerno/Evaluation/TROTA_2018_plots/tt_semilep_noResinMix/"+canv_name+".pdf")
    else:
        CMS.SaveCanvas(canv, "/eos/user/f/fsalerno/Evaluation/TROTA_2018_plots/"+sample+"_noResinMix/"+canv_name+".png", close=False)
        CMS.SaveCanvas(canv, "/eos/user/f/fsalerno/Evaluation/TROTA_2018_plots/"+sample+"_noResinMix/"+canv_name+".pdf")
...
for t in h.keys():        
    ...
    for idx, h1d in enumerate(h1d_list):
        ...
        if "tt" in sample:
            CMS.SaveCanvas(canv, f"/eos/user/f/fsalerno/Evaluation/TROTA_2018_plots/tt_semilep_noResinMix/{canv_name}.png", close=False)
            CMS.SaveCanvas(canv, f"/eos/user/f/fsalerno/Evaluation/TROTA_2018_plots/tt_semilep_noResinMix/{canv_name}.pdf")
        else:
            CMS.SaveCanvas(canv, f"/eos/user/f/fsalerno/Evaluation/TROTA_2018_plots/{sample}_noResinMix/{canv_name}.png", close=False)
            CMS.SaveCanvas(canv, f"/eos/user/f/fsalerno/Evaluation/TROTA_2018_plots/{sample}_noResinMix/{canv_name}.pdf")