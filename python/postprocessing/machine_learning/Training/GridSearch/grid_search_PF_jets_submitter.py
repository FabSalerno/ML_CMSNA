...
def sh_writer(shfileName_toRun, save_graphics, pt_flatten, path_to_h5_folder, h5Name, path_to_graphics_folder, path_to_model_folder, modelName):
    f = open("runner_"+shfileName_toRun+".sh", "w")
    f.write("#!/usr/bin/bash\n")
    f.write("cd /afs/cern.ch/user/f/fsalerno/CMSSW_13_2_11/src/PhysicsTools/NanoAODTools/python/postprocessing/machine_learning/Training/GridSearch/\n")
    f.write("cmsenv\n")
    f.write("export XRD_NETWORKSTACK=IPv4\n")
    f.write(f"python3 grid_search_PF_jets_CNN2D_LSTM.py -save_graphics {save_graphics} -pt_flatten {pt_flatten} -path_to_h5_folder {path_to_h5_folder} -h5Name {h5Name} -path_to_graphics_folder {path_to_graphics_folder} -path_to_model_folder {path_to_model_folder} -modelName {modelName}\n")
...
# save_graphics           = True
# path_to_h5_folder      = "/afs/cern.ch/user/l/lfavilla/CMSSW_12_6_0/src/PhysicsTools/NanoAODTools/python/postprocessing/my_analysis/my_framework/MLstudies/Training"
# h5Name                 = "trainingSet.h5"
path_to_models          = "/eos/user/f/fsalerno/framework/MachineLearning/Grid_search_1/grid_search_models/PF_jets_boosted_CNN2D_LSTM_mp"
save_graphics           = True
path_to_h5_folder      = "/eos/user/f/fsalerno/framework/MachineLearning/TrainingSet_PF_folder/Full"
h5Name                 = "trainingSet_preprocessed_0_pt.h5"
...
shfileName_toRun        = "GridSearch_base_1_PF_jets_boosted_CNN2D_LSTM_mp"
path_to_graphics_folder = "/eos/user/f/fsalerno/framework/MachineLearning/Grid_search_1/graphics_gridsearch/PF_jets_boosted_CNN2D_LSTM_mp"
path_to_model_folder    = "/eos/user/f/fsalerno/framework/MachineLearning/Grid_search_1/grid_search_models/PF_jets_boosted_CNN2D_LSTM_mp"
...
sh_writer(shfileName_toRun      = shfileName_toRun,
        ...
        pt_flatten              = False,
        path_to_h5_folder       = path_to_h5_folder,
        h5Name                  = h5Name,
