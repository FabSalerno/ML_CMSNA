...
class trainer:
    ...
    def cross_validate(self, epochs=1000, batch_size=250, validation_split=0.2, verbose=True):
        # Inizializza KFold
        ...
        fold = 1
        for train_index, val_index in kf.split(self.X_jet):
            print(f"\n--- Fold {fold}/5 ---\n")

            # Creazione dei set di train e validation
...
print("ATTENZIONE PROVA COMPONENTI", samples)
